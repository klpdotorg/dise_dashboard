...
class Command(BaseCommand):
    ...
    INDEXES = {
        'School_Code': 0,
        'acyear': 1,
        'Class1_Total_Enr_Boys': 2,
        'Class2_Total_Enr_Boys': 3,
        'Class3_Total_Enr_Boys': 4,
        'Class4_Total_Enr_Boys': 5,
        'Class5_Total_Enr_Boys': 6,
        'Class6_Total_Enr_Boys': 7,
        'Class7_Total_Enr_Boys': 8,
        'Class8_Total_Enr_Boys': 9,
        'Class1_Total_Enr_Girls': 10,
        'Class2_Total_Enr_Girls': 11,
        'Class3_Total_Enr_Girls': 12,
        'Class4_Total_Enr_Girls': 13,
        'Class5_Total_Enr_Girls': 14,
        'Class6_Total_Enr_Girls': 15,
        'Class7_Total_Enr_Girls': 16,
        'Class8_Total_Enr_Girls': 17,
    }
    ...
    def process_row(self, row, year):
        ...
        with transaction.commit_on_success():
            ...
            try:
                Enrolment.objects.bulk_create(enrolment_list)
            except Exception as e:
                print str(e)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schools_school', 'centroid',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'schools_school', 'centroid')
    ...
    models = {
        ...
        u'schools.school': {
            ...
            'centroid': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}),

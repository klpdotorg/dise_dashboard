...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeacherCount'
        db.create_table(u'schools_teachercount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')()),
            ('yearly_data', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['schools.YearlyData'], unique=True)),
            ('male', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('female', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('noresp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('graduate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('with_prof_qual', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('days_in_non_tch', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('involved_in_non_tch', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'schools', ['TeacherCount'])


    def backwards(self, orm):
        # Deleting model 'TeacherCount'
        db.delete_table(u'schools_teachercount')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolBuildingStatus'
        db.create_table(u'schools_schoolbuildingstatus', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'schools', ['SchoolBuildingStatus'])


    def backwards(self, orm):
        # Deleting model 'SchoolBuildingStatus'
        db.delete_table(u'schools_schoolbuildingstatus')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.klpid'
        db.add_column(u'schools_school', 'klpid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.klpid'
        db.delete_column(u'schools_school', 'klpid')
    ...
    models = {
        ...
        u'schools.school': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'klpid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'unique': 'True', 'null': 'True', 'blank': 'True'}),

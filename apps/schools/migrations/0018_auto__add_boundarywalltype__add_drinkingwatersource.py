...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BoundaryWallType'
        db.create_table(u'schools_boundarywalltype', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'schools', ['BoundaryWallType'])

        # Adding model 'DrinkingWaterSource'
        db.create_table(u'schools_drinkingwatersource', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'schools', ['DrinkingWaterSource'])


    def backwards(self, orm):
        # Deleting model 'BoundaryWallType'
        db.delete_table(u'schools_boundarywalltype')

        # Deleting model 'DrinkingWaterSource'
        db.delete_table(u'schools_drinkingwatersource')

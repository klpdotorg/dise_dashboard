...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YearlyData.room_for_headmaster'
        db.add_column(u'schools_yearlydata', 'room_for_headmaster',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.drinking_water_source'
        db.add_column(u'schools_yearlydata', 'drinking_water_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.DrinkingWaterSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.electricity_status'
        db.add_column(u'schools_yearlydata', 'electricity_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.boundary_wall_type'
        db.add_column(u'schools_yearlydata', 'boundary_wall_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.BoundaryWallType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.library_available'
        db.add_column(u'schools_yearlydata', 'library_available',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.library_book_count'
        db.add_column(u'schools_yearlydata', 'library_book_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'YearlyData.playground_available'
        db.add_column(u'schools_yearlydata', 'playground_available',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.computer_count'
        db.add_column(u'schools_yearlydata', 'computer_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'YearlyData.cal_lab_available'
        db.add_column(u'schools_yearlydata', 'cal_lab_available',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.medical_checkup'
        db.add_column(u'schools_yearlydata', 'medical_checkup',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.ramp_available'
        db.add_column(u'schools_yearlydata', 'ramp_available',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YearlyData.room_for_headmaster'
        db.delete_column(u'schools_yearlydata', 'room_for_headmaster')

        # Deleting field 'YearlyData.drinking_water_source'
        db.delete_column(u'schools_yearlydata', 'drinking_water_source_id')

        # Deleting field 'YearlyData.electricity_status'
        db.delete_column(u'schools_yearlydata', 'electricity_status')

        # Deleting field 'YearlyData.boundary_wall_type'
        db.delete_column(u'schools_yearlydata', 'boundary_wall_type_id')

        # Deleting field 'YearlyData.library_available'
        db.delete_column(u'schools_yearlydata', 'library_available')

        # Deleting field 'YearlyData.library_book_count'
        db.delete_column(u'schools_yearlydata', 'library_book_count')

        # Deleting field 'YearlyData.playground_available'
        db.delete_column(u'schools_yearlydata', 'playground_available')

        # Deleting field 'YearlyData.computer_count'
        db.delete_column(u'schools_yearlydata', 'computer_count')

        # Deleting field 'YearlyData.cal_lab_available'
        db.delete_column(u'schools_yearlydata', 'cal_lab_available')

        # Deleting field 'YearlyData.medical_checkup'
        db.delete_column(u'schools_yearlydata', 'medical_checkup')

        # Deleting field 'YearlyData.ramp_available'
        db.delete_column(u'schools_yearlydata', 'ramp_available')

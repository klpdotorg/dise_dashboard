...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YearlyData.academic_inspection_count'
        db.add_column(u'schools_yearlydata', 'academic_inspection_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.crc_visit_count'
        db.add_column(u'schools_yearlydata', 'crc_visit_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.brc_visit_count'
        db.add_column(u'schools_yearlydata', 'brc_visit_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.development_grant_received'
        db.add_column(u'schools_yearlydata', 'development_grant_received',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.development_grant_expenditure'
        db.add_column(u'schools_yearlydata', 'development_grant_expenditure',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.tlm_grant_received'
        db.add_column(u'schools_yearlydata', 'tlm_grant_received',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.tlm_grant_expenditure'
        db.add_column(u'schools_yearlydata', 'tlm_grant_expenditure',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.fund_from_student_received'
        db.add_column(u'schools_yearlydata', 'fund_from_student_received',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.fund_from_student_expenditure'
        db.add_column(u'schools_yearlydata', 'fund_from_student_expenditure',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YearlyData.academic_inspection_count'
        db.delete_column(u'schools_yearlydata', 'academic_inspection_count')

        # Deleting field 'YearlyData.crc_visit_count'
        db.delete_column(u'schools_yearlydata', 'crc_visit_count')

        # Deleting field 'YearlyData.brc_visit_count'
        db.delete_column(u'schools_yearlydata', 'brc_visit_count')

        # Deleting field 'YearlyData.development_grant_received'
        db.delete_column(u'schools_yearlydata', 'development_grant_received')

        # Deleting field 'YearlyData.development_grant_expenditure'
        db.delete_column(u'schools_yearlydata', 'development_grant_expenditure')

        # Deleting field 'YearlyData.tlm_grant_received'
        db.delete_column(u'schools_yearlydata', 'tlm_grant_received')

        # Deleting field 'YearlyData.tlm_grant_expenditure'
        db.delete_column(u'schools_yearlydata', 'tlm_grant_expenditure')

        # Deleting field 'YearlyData.fund_from_student_received'
        db.delete_column(u'schools_yearlydata', 'fund_from_student_received')

        # Deleting field 'YearlyData.fund_from_student_expenditure'
        db.delete_column(u'schools_yearlydata', 'fund_from_student_expenditure')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YearlyData.sdmc_constituted'
        db.add_column(u'schools_yearlydata', 'sdmc_constituted',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.sdmc_meeting_count'
        db.add_column(u'schools_yearlydata', 'sdmc_meeting_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'YearlyData.textbook_received'
        db.add_column(u'schools_yearlydata', 'textbook_received',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.textbook_received_date'
        db.add_column(u'schools_yearlydata', 'textbook_received_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.weakersec_children_applied'
        db.add_column(u'schools_yearlydata', 'weakersec_children_applied',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'YearlyData.weakersec_children_enrolled'
        db.add_column(u'schools_yearlydata', 'weakersec_children_enrolled',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'YearlyData.middaymeal_status'
        db.add_column(u'schools_yearlydata', 'middaymeal_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'YearlyData.kitchenshed_status'
        db.add_column(u'schools_yearlydata', 'kitchenshed_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YearlyData.sdmc_constituted'
        db.delete_column(u'schools_yearlydata', 'sdmc_constituted')

        # Deleting field 'YearlyData.sdmc_meeting_count'
        db.delete_column(u'schools_yearlydata', 'sdmc_meeting_count')

        # Deleting field 'YearlyData.textbook_received'
        db.delete_column(u'schools_yearlydata', 'textbook_received')

        # Deleting field 'YearlyData.textbook_received_date'
        db.delete_column(u'schools_yearlydata', 'textbook_received_date')

        # Deleting field 'YearlyData.weakersec_children_applied'
        db.delete_column(u'schools_yearlydata', 'weakersec_children_applied')

        # Deleting field 'YearlyData.weakersec_children_enrolled'
        db.delete_column(u'schools_yearlydata', 'weakersec_children_enrolled')

        # Deleting field 'YearlyData.middaymeal_status'
        db.delete_column(u'schools_yearlydata', 'middaymeal_status')

        # Deleting field 'YearlyData.kitchenshed_status'
        db.delete_column(u'schools_yearlydata', 'kitchenshed_status')
    ...
    models = {
        ...
        u'schools.teachercount': {
            'Meta': {'ordering': "('id',)", 'object_name': 'TeacherCount'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {}),
            'days_in_non_tch': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'female': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'graduate': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'involved_in_non_tch': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'male': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'noresp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'with_prof_qual': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'yearly_data': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['schools.YearlyData']", 'unique': 'True'})
        },
        u'schools.toilet': {
        ...
        u'schools.yearlydata': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kitchenshed_status': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'middaymeal_status': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'sdmc_constituted': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'sdmc_meeting_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'textbook_received': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'textbook_received_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'weakersec_children_applied': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'weakersec_children_enrolled': ('django.db.models.fields.IntegerField', [], {'default': '0'}),

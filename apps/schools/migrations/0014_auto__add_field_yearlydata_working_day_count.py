...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YearlyData.working_day_count'
        db.add_column(u'schools_yearlydata', 'working_day_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YearlyData.working_day_count'
        db.delete_column(u'schools_yearlydata', 'working_day_count')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schools_enrolment', (
            ...
            ('klass', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('general_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('general_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sc_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sc_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('st_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('st_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('obc_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('obc_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('disabled_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('disabled_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('repeaters_boys', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('repeaters_girls', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_boys', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('total_girls', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal(u'schools', ['Enrolment'])


    def backwards(self, orm):
        # Deleting model 'Enrolment'
        db.delete_table(u'schools_enrolment')
    ...
    models = {
        ...
        u'schools.enrolment': {
            'Meta': {'ordering': "('id',)", 'object_name': 'Enrolment'},

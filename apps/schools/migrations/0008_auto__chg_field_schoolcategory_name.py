...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SchoolCategory.name'
        db.alter_column(u'schools_schoolcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'SchoolCategory.name'
        db.alter_column(u'schools_schoolcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'School.ward_no'
        db.alter_column(u'schools_school', 'ward_no', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'School.ward_no'
        db.alter_column(u'schools_school', 'ward_no', self.gf('django.db.models.fields.IntegerField')(null=True))

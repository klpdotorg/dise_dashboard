...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'Room', fields ['count']
        db.delete_index(u'schools_room', ['count'])

        # Adding unique constraint on 'Room', fields ['type', 'condition', 'yearly_data']
        db.create_unique(u'schools_room', ['type', 'condition', 'yearly_data_id'])

        # Removing index on 'Toilet', fields ['count']
        db.delete_index(u'schools_toilet', ['count'])

        # Adding unique constraint on 'Toilet', fields ['type', 'yearly_data']
        db.create_unique(u'schools_toilet', ['type', 'yearly_data_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Toilet', fields ['type', 'yearly_data']
        db.delete_unique(u'schools_toilet', ['type', 'yearly_data_id'])

        # Adding index on 'Toilet', fields ['count']
        db.create_index(u'schools_toilet', ['count'])

        # Removing unique constraint on 'Room', fields ['type', 'condition', 'yearly_data']
        db.delete_unique(u'schools_room', ['type', 'condition', 'yearly_data_id'])

        # Adding index on 'Room', fields ['count']
        db.create_index(u'schools_room', ['count'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Enrolment', fields ['klass', 'yearly_data']
        db.create_unique(u'schools_enrolment', ['klass', 'yearly_data_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Enrolment', fields ['klass', 'yearly_data']
        db.delete_unique(u'schools_enrolment', ['klass', 'yearly_data_id'])

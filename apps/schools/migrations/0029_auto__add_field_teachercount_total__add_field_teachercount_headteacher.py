...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherCount.total'
        db.add_column(u'schools_teachercount', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TeacherCount.headteacher'
        db.add_column(u'schools_teachercount', 'headteacher',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherCount.total'
        db.delete_column(u'schools_teachercount', 'total')

        # Deleting field 'TeacherCount.headteacher'
        db.delete_column(u'schools_teachercount', 'headteacher')
    ...
    models = {
        ...
        u'schools.teachercount': {
            ...
            'headteacher': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

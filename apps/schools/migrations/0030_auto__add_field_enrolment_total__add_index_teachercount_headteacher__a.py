...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enrolment.total'
        db.add_column(u'schools_enrolment', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding index on 'TeacherCount', fields ['headteacher']
        db.create_index(u'schools_teachercount', ['headteacher'])

        # Adding index on 'TeacherCount', fields ['total']
        db.create_index(u'schools_teachercount', ['total'])


    def backwards(self, orm):
        # Removing index on 'TeacherCount', fields ['total']
        db.delete_index(u'schools_teachercount', ['total'])

        # Removing index on 'TeacherCount', fields ['headteacher']
        db.delete_index(u'schools_teachercount', ['headteacher'])

        # Deleting field 'Enrolment.total'
        db.delete_column(u'schools_enrolment', 'total')
    ...
    models = {
        ...
        u'schools.teachercount': {
            ...
            'headteacher': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

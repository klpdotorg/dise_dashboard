DROP TABLE IF EXISTS dise_1011_assembly_aggregations;

CREATE TABLE dise_1011_assembly_aggregations AS
...
DROP TABLE IF EXISTS dise_1112_assembly_aggregations;

CREATE TABLE dise_1112_assembly_aggregations AS
SELECT assembly_name,
    Count(school_code) AS sum_schools,
    Sum(CASE WHEN rural_urban = 1 THEN 1 ELSE 0 END) AS sum_rural_schools,

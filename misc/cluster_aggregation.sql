DROP TABLE IF EXISTS dise_1011_cluster_aggregations;

CREATE TABLE dise_1011_cluster_aggregations AS
SELECT cluster_name,
    block_name,
...
DROP TABLE IF EXISTS dise_1112_cluster_aggregations;

CREATE TABLE dise_1112_cluster_aggregations AS
SELECT cluster_name,
    block_name,
    Count(school_code) AS sum_schools,
    Sum(CASE WHEN rural_urban = 1 THEN 1 ELSE 0 END) AS sum_rural_schools,
